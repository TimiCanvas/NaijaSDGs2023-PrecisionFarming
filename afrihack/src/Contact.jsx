...
const Contact = () => {
  return (
    <div className='bg-[#1e1e1e] min-h-[60rem] '>
       
        <p className='text-center text-white font-bold'> Contact us</p>
        
        <img src={crop3} className='mx-auto mt-9'/>
        <div className='flex justify-center items-center flex-col mt-[100px] text-white'>
        <a href="mailto:adeyemishedracktimi@gmail.com">adeyemishedracktimi@gmail.com</a>
        ...
        <button className='border-[1px] border-green-500 text-white p-[10px] mx-auto mt-[100px]'>Start Now</button>
        </div>
